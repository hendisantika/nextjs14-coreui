                ...
                <div className="col-sm-6 col-lg-3">
                    ...
                    <FontAwesomeIcon icon={faArrowDown} fixedWidth/>
                            ...
                            <Dropdown align="end">
                                ...
                                <DropdownMenu>
                                    <DropdownItem
                                        href="#/action-1">{dict.dashboard.featured.action.action1}</DropdownItem>
                                    <DropdownItem
                                        href="#/action-2">{dict.dashboard.featured.action.action2}</DropdownItem>
                                    <DropdownItem
                                        href="#/action-3">{dict.dashboard.featured.action.action3}</DropdownItem>
                                </DropdownMenu>
                            </Dropdown>
                        </CardBody>
                ...
                <CardBody>
                    <div className="d-flex justify-content-between">
                        <div>
                            ...
                            <div
                                className="small text-black-50 dark:text-gray-500">{dict.dashboard.traffic.duration}</div>
                        </div>
                            ...
                            <div className="table-responsive">
                                <table className="table border mb-0">
                                    ...
                                    <tr className="align-middle">
                                        ...
                                        <td>
                                            <div
                                                className="small text-black-50 dark:text-gray-500">{dict.dashboard.listing.last_login}</div>
                                            <div
                                                className="fw-semibold">{dict.dashboard.listing.items.item1.login_at}</div>
                                        </td>
                                        <td>
                                            <Dropdown align="end">
                                                <DropdownToggle
                                    ...
                                    <tr className="align-middle">
                                        ...
                                        <td>
                                            <div
                                                className="small text-black-50 dark:text-gray-500">{dict.dashboard.listing.last_login}</div>
                                            <div
                                                className="fw-semibold">{dict.dashboard.listing.items.item2.login_at}</div>
                                        </td>
                                        <td>
                                            <Dropdown align="end">
                                                <DropdownToggle
                                    ...
                                    <tr className="align-middle">
                                        ...
                                        <td>
                                            <div
                                                className="small text-black-50 dark:text-gray-500">{dict.dashboard.listing.last_login}</div>
                                            <div
                                                className="fw-semibold">{dict.dashboard.listing.items.item3.login_at}</div>
                                        </td>
                                        <td>
                                            <Dropdown align="end">
                                                <DropdownToggle
                                    ...
                                    <tr className="align-middle">
                                        ...
                                        <td>
                                            <div
                                                className="small text-black-50 dark:text-gray-500">{dict.dashboard.listing.last_login}</div>
                                            <div
                                                className="fw-semibold">{dict.dashboard.listing.items.item4.login_at}</div>
                                        </td>
                                        <td>
                                            <Dropdown align="end">
                                                <DropdownToggle
                                    ...
                                    <tr className="align-middle">
                                        ...
                                        <td>
                                            <div
                                                className="small text-black-50 dark:text-gray-500">{dict.dashboard.listing.last_login}</div>
                                            <div
                                                className="fw-semibold">{dict.dashboard.listing.items.item5.login_at}</div>
                                        </td>
                                        <td>
                                            <Dropdown align="end">
                                                <DropdownToggle
                                    ...
                                    <tr className="align-middle">
                                        ...
                                        <td>
                                            <div
                                                className="small text-black-50 dark:text-gray-500">{dict.dashboard.listing.last_login}</div>
                                            <div
                                                className="fw-semibold">{dict.dashboard.listing.items.item6.login_at}</div>
                                        </td>
                                        <td>
                                            <Dropdown align="end">
                                                <DropdownToggle
