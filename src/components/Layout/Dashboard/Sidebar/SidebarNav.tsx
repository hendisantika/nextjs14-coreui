import {faAddressCard, faBell, faFileLines, faStar,} from '@fortawesome/free-regular-svg-icons'
import {
    faBug,
    faCalculator,
    faChartPie,
...
export default async function SidebarNav() {
    ...
    return (
        <ul className="list-unstyled">
            ...
            <SidebarNavItem icon={faLayerGroup}
                            href="https://coreui.io/pro/">{dict.sidebar.items.try_core_ui_pro}</SidebarNavItem>
        </ul>
    )
}
