        ...
        <Nav>
            <NavItem className="d-none d-sm-block">
                <Dropdown>
                    ...
                    <DropdownMenu className="pt-0" align="end">
                        <DropdownHeader
                            className="fw-bold rounded-top">{dict.notification.message.replace('{{total}}', '5')}</DropdownHeader>
            ...
            <NavItem className="d-none d-sm-block">
                <Dropdown>
                    ...
                    <DropdownMenu className="pt-0" align="end">
                        <DropdownHeader
                            className="fw-bold rounded-top">{dict.task.message.replace('{{total}}', '5')}</DropdownHeader>
            ...
            <NavItem className="d-none d-sm-block">
                <Dropdown>
                    ...
                    <DropdownMenu className="pt-0" align="end">
                        <DropdownHeader
                            className="fw-bold rounded-top">{dict.messages.message.replace('{{total}}', '4')}</DropdownHeader>
                        <Link href="#" passHref legacyBehavior>
                            <DropdownItem>
